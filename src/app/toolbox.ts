export const toolbox_week2 = `<xml xmlns="http://www.w3.org/1999/xhtml" id="toolbox" style="display: none;">
    ...
    <category name="Arrays" colour="#745CA6">
    ...
    <category name="Utilities" colour="#5CA68D">
